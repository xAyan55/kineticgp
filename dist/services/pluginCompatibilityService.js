...
exports.PluginCompatibilityService = void 0;
class PluginCompatibilityService {
     ...
     */
    static isSupportedServerSoftware(server) {
        if (!server || !server.software)
            return false;
     ...
     */
    static isPluginProject(project) {
        if (!project)
            return false;
     ...
     */
    static isPluginVersion(version, server) {
     ...
     */
    static selectPrimaryFile(version) {
        if (!version || !version.files || version.files.length === 0)
            return null;
...
exports.PluginCompatibilityService = PluginCompatibilityService;
